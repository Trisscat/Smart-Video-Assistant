...
from config import UPLOAD_DIR, RESULT_DIR, MAX_CONCURRENT_VIDEOS
from audio_utils import extract_audio
from transcriber import VideoTranscriber
from agents import VideoAnalysisAgents
...
class VideoProcessingOrchestrator:
    ...
    def __init__(self):
        ...
        self.agents: Optional[VideoAnalysisAgents] = None
    ...
    def init_models(self, whisper_model):
        ...
        self.agents = VideoAnalysisAgents()
    ...
    def _process_video(self, task_id: str):
        ...
        if self._check_cancelled(task_id):
            return
        self._update_progress(task_id, 60, "正在进行多智能体分析...", "analyzing")

        try:
            analysis_result = self.agents.analyze_video(
